...
namespace Store.Web.App
{
    public class OrderService
    {
        ...
        public OrderModel AddBook(int bookId, uint count)
        {
            if (count < 1)
        ...
        internal void AddOrUpdateBook(Order order, int bookId, uint count)
        {
        ...
        public OrderModel UpdateBook(int bookId, uint count)
        {
            var order = GetOrder();
